...
- The server was renamed to "DC01"  ![Rename Server](../images/ws2025-remame-server.png)
- A static IP address was configured on the server ![Static IP Configuration](../images/ws2025-static-ip.png)
